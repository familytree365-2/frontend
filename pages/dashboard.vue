<template>
  <v-app>
    ...
    <v-card outlined shaped>
      ...
      <v-toolbar flat>
        <v-row>
          ...
          <v-col>
            <v-btn @click="search" color="success" block>Search</v-btn>
          </v-col>
        </v-row>
      </v-toolbar>
      <v-data-table
        ...
        <div class="card has-background-white has-text-black">
          <div class="card-content is-flex jc--sb">
            ...
            <div class="has-text-right">
              ...
              <div class="is-size-7 has-text-black has-text-weight-medium mt-x5">
                <NuxtLink
                    to="/gedcom"
                    class="button
    ...
    <div class="columns is-variable is-flex-desktop-only ai--s">
      <div class="col-md-4 col-sm-12 justify-center align-center">
        <div
            v-if="loggedInUser.role.name == 'free'"
            class="card has-background-primary has-text-centered fill-height d-flex justify-center align-center"
        >
          <div class="card-content">
            <p class="is-size-7 title">Buy Plan</p>
            <NuxtLink
                to="/subscription"
                class="
                button
                is-size-7 is-uppercase
                has-text-weight-medium has-background-info has-text-white
                is-light
                mt-4
              "
            >Subscribe</NuxtLink
      ...
      <div class="col-md-8 col-sm-12">
        <div class="card has-background-white has-text-black fill-height">
          <div class="card-content has-text-centered py-5">
            ...
            <div class="row">
              <div class="col-6">
                <label>Invited Companies</label>
                <vue-select
                    label="name"
                    v-model="selected_inv_company"
                    :reduce="(in_company) => in_company.id"
                    :options="inv_companies"
                    @input="setSelectedInv"
                ></vue-select>
...
export default {
  ...
  methods: {
    ...
    async setSelectedInv(value) {
      const response = await this.$axios.$post('/api/dashboard/changedb', {
        company_id: this.selected_inv_company,
